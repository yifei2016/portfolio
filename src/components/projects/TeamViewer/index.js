...
const TeamViewer = () => (
  <Project  href="http://html-css.surge.sh" title="TeamViewer">
    ...
    ingår en beskrivning av företaget och presentation av våra team medlemmar med text och bild, 
    presentation av företags produkter, en sida visar hur det skulle se ut om man lagt till några produkter 
    i kundvagnen och är på väg att checka ut, en blog sida innehålller text och bild med flera längre artiklar 
    efter varandra, en diskussionsforum sida med rubriker på trådar. Websidor är responsiva, enhetligt byggda och 
    har genomtänkt och strukturerad design.
    </Point>
    <Point>
