...
const ChatSidan = () => (
  <Project href="https://github.com/yifei2016/localStorage-firebase"  title="ChatSidan">
    ...
    och sen namnet visas på webbsidan. Efter man har loggat in, kan man skriva ett meddelande 
    via textarea sen kan det sparas i Firebase databasen, alla meddelandet visas i en tabell med 
    det nyaste överst, där besökaren kan gilla/ogilla meddelanden via knappar och databasen uppdateras dynamiskt. 
    </Point>
    <Point>
