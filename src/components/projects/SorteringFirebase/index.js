...
const SorteringFirebase = () => (
  <Project href="https://github.com/yifei2016" title="SorteringFirebase">
    <Point>
    En webbsida som använder Firebase funktioner för att sortera och filtrera produkter 
    efter deras produkts pris och namnens alfabetisk ordningen, och man kan se data som ligger i 
