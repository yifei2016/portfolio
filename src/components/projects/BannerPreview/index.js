...
const BannerPreview = () => (
  <Project href="https://demo.fullystudios.se/banner-preview/" title="Banner Preview">
    <Point>
    Ett projekt som använder webpack för att bygga hela projekt struktur, och React.js som ramverk, 
    detta projekt visar olika banners som är Iframe och video format som hämtas dynamiskt från json fil. 
    Applikationen har en responsiv design med Flexbox och Media queries, Jag jobbade med hela front end utveckling och deploy, QA.
    </Point>
    <Point>
